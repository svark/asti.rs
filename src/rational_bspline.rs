...
use bspline::{Bspline, ClassInvariant};
...
{
    type T = Point::H;
    fn control_points(&self) -> &Vec<Point::H> {
        self.spl.control_points()
    }
...
impl<T> KnotManip for RationalBspline<T>
    where T: VectorSpace
{
